...
export default function Legacy() {
  // Ultra-Smooth Luxury Animation Variants
  const containerVariants: Variants = {
    hidden: { opacity: 0 },
    visible: {
      opacity: 1,
      transition: {
        delayChildren: 0.2, // Scroll karne ke baad thoda ruk kar aayega
        staggerChildren: 0.4, // Ek ke baad ek aane ka time gap
      },
    },
  };

  const itemVariants: Variants = {
    hidden: { opacity: 0, y: 80 }, // Neeche se upar aayega
    visible: {
      opacity: 1,
      y: 0,
      transition: {
        duration: 1.8, // Slow aur elegant movement
        ease: [0.25, 1, 0.5, 1], // Smooth luxury easing curve
      },
    },
  };
    ...
    <div className="bg-[#F8F5F0] min-h-screen font-sans">
      ...
      <section className="relative w-full h-[70vh] md:h-[85vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1594040226829-7f251ab46d80?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cnVnfGVufDB8MHwwfHx8MA%3D%3D" 
        ...
        {/* Hero text will animate immediately on load */}
        <motion.div 
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-[#DFD8CC] text-lg font-light tracking-widest uppercase text-xs md:text-sm">
      ...
      >
        ...
        <motion.p variants={itemVariants} className="text-[#6B6054] text-lg leading-relaxed font-light mb-8">
      ...
      >
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 px-8 py-24 md:p-32 flex flex-col justify-center">
            <motion.span variants={itemVariants} className="text-[#C19A6B] uppercase tracking-[0.2em] font-semibold text-xs mb-4">Our Workshop</motion.span>
            <motion.h3 variants={itemVariants} className="text-4xl font-serif text-[#3A332C] mb-8">Precision in Every Stitch</motion.h3>
            <motion.p variants={itemVariants} className="text-[#6B6054] leading-relaxed font-light mb-6">
            ...
            <motion.p variants={itemVariants} className="text-[#6B6054] leading-relaxed font-light">
      ...
      >
        <motion.svg variants={itemVariants} className="w-8 h-8 text-[#C19A6B] mb-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></motion.svg>
        <motion.h2 variants={itemVariants} className="text-3xl md:text-5xl font-serif text-[#F8F5F0] mb-8">Experience the Legacy</motion.h2>
        <motion.p variants={itemVariants} className="text-[#DFD8CC] font-light mb-12 max-w-lg">Bring the unmatched quality of direct manufacturing into your home.</motion.p>
        <motion.a variants={itemVariants} href="/collections" className="bg-[#C19A6B] text-white px-10 py-4 text-xs tracking-[0.2em] uppercase hover:bg-[#F8F5F0] hover:text-[#3A332C] transition duration-500 shadow-md">
