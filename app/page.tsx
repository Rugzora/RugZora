...
export default function Home() {
  ...
  return (
    <div className="w-full flex flex-col bg-[#F8F5F0] overflow-x-hidden font-sans">
      ...
      {/* 2. THE BRAND ETHOS (🌟 No Entry Animation for these 3 images to fix lag) */}
      <section className="w-full max-w-[1400px] mx-auto px-6 py-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            { img: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", title: "Curated for Living", desc: "Designs that effortlessly blend with minimalism and classic elegance." },
            { img: "https://images.pexels.com/photos/39005790/pexels-photo-39005790.jpeg", title: "Natural Textures", desc: "Embracing the raw, earthy beauty of pure materials and sustainable sourcing.", extraClass: "md:mt-16" },
            { img: "https://images.pexels.com/photos/31598222/pexels-photo-31598222.jpeg", title: "Master Craftsmanship", desc: "Every thread meticulously secured using precision zigzag machinery." }
          ].map((item, index) => (
            <div 
              key={index}
            ...
            >
              <div className="aspect-[4/3] overflow-hidden mb-8 rounded-sm bg-[#EBE5DA]">
                {/* 🌟 loading="lazy" & decoding="async" Rakha hai lag hatane ke liye */}
                <img src={item.img} alt={item.title} loading="lazy" decoding="async" className="w-full h-full object-cover group-hover:scale-105 transition duration-1000" />
              </div>
      ...
      {/* 3. SPLIT STORY - Legacy (🌟 Animations Restored) */}
      <section className="w-full max-w-[1400px] mx-auto px-6 py-24 border-t border-[#EBE5DA]">
        <div className="flex flex-col md:flex-row items-center gap-20">
          ...
          >
            <img src="https://media.istockphoto.com/id/2241474699/photo/rolling-up-a-colorful-rug-in-a-cozy-living-space.jpg?b=1&s=612x612&w=0&k=20&c=YCZM8PgDSFYKG7JTCxgW4HqYBrUVqECzMpiVk3J3x2I=" alt="Soft Cut Pile Carpet" loading="lazy" decoding="async" className="w-full h-full object-cover group-hover:scale-105 transition duration-[2s]" />
          </motion.div>
        </div>
      </section>

      {/* 4. THE MASTERPIECES (🌟 Animations Restored) */}
      ...
      {/* 5. THE CRAFT (🌟 Animations Restored) */}
      <section className="w-full max-w-[1400px] mx-auto px-6 py-32 border-b border-[#EBE5DA]">
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 1.5, ease: "easeOut" }} viewport={{ once: true }} className="w-full md:w-7/12 order-1 md:order-2 relative h-[800px] rounded-sm overflow-hidden group bg-[#EBE5DA]">
            <img src="https://images.unsplash.com/photo-1544816155-12df9643f363?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" loading="lazy" decoding="async" alt="Weaving Thread Details" className="w-full h-full object-cover group-hover:scale-105 transition duration-[2s]" />
          </motion.div>
        </div>
      </section>

      {/* 6. THE TEXTURE LIBRARY (🌟 Animations Restored) */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <motion.div key={index} variants={fadeUpVariant} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ delay: index * 0.15, duration: 1 }} className="aspect-square bg-[#EBE5DA] overflow-hidden group">
                <img src={img} alt={`Texture ${index+1}`} loading="lazy" decoding="async" className="w-full h-full object-cover group-hover:scale-110 transition duration-700" />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* 7. SHOP BY SPACE (🌟 Animations Restored) */}
      ...
      {/* 8. FOCUS COLLECTION (🌟 Animations Restored) */}
      <section className="w-full max-w-[1400px] mx-auto px-6 py-32 relative">
        <div className="flex flex-col md:flex-row gap-10">
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1.5, ease: "easeOut" }} viewport={{ once: true }} className="w-full md:w-2/3 h-[700px] bg-[#EBE5DA] relative overflow-hidden rounded-sm">
            <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" loading="lazy" decoding="async" alt="Living Area Jute" className="w-full h-full object-cover" />
          </motion.div>
          <motion.div variants={fadeUpVariant} initial="hidden" whileInView="visible" viewport={{ once: true }} className="w-full md:w-1/3 md:absolute md:right-10 md:top-48 bg-white p-12 shadow-2xl max-w-md">
            ...
            <div className="h-40 bg-[#EBE5DA] mb-8 overflow-hidden">
               <img src="https://images.unsplash.com/photo-1590118318182-3d5f35fc0ea4?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" loading="lazy" decoding="async" alt="Jute Detail" className="w-full h-full object-cover" />
            </div>
      ...
      {/* 9. INSPIRATION GALLERY (🌟 Animations Restored) */}
      <section className="w-full max-w-[1400px] mx-auto px-6 py-32">
        <motion.div variants={fadeUpVariant} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-auto md:h-[800px]">
          <div className="flex flex-col gap-6">
            <motion.div variants={fadeUpVariant} initial="hidden" whileInView="visible" viewport={{ once: true }} className="h-[400px] bg-[#EBE5DA] rounded-sm overflow-hidden group">
              <img src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" loading="lazy" decoding="async" alt="Gallery 1" className="w-full h-full object-cover group-hover:scale-105 transition duration-1000" />
            </motion.div>
            <motion.div variants={fadeUpVariant} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ delay: 0.3 }} className="h-[400px] bg-[#EBE5DA] rounded-sm overflow-hidden group">
              <img src="https://images.unsplash.com/photo-1598928506311-c55dd129a0f4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" loading="lazy" decoding="async" alt="Gallery 2" className="w-full h-full object-cover group-hover:scale-105 transition duration-1000" />
            </motion.div>
          </div>
          <motion.div variants={fadeUpVariant} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ delay: 0.6 }} className="h-[400px] md:h-full bg-[#EBE5DA] rounded-sm overflow-hidden group">
            <img src="https://images.unsplash.com/photo-1600566753086-00f18efc2294?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" loading="lazy" decoding="async" alt="Gallery 3" className="w-full h-full object-cover group-hover:scale-105 transition duration-1000" />
          </motion.div>
        </div>
      </section>

      {/* 10. THE DISTINCTION (🌟 Animations Restored) */}
      ...
      {/* 11. THE ARTISAN PROMISE (🌟 Animations Restored) */}
      <motion.section 
      ...
      >
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" loading="lazy" decoding="async" alt="Authentic Bhadohi Carpet" className="w-full h-full object-cover" />
